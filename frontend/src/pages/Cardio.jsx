      ...
      {loading && cardioLogs.length === 0 ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Cardio logs feed */}
            <div className="order-2 lg:order-1 lg:col-span-2 glass rounded-3xl p-4 sm:p-6 border border-card-border/80 space-y-4">
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col items-start gap-1 sm:flex-row sm:items-center sm:gap-2">
                          ...
                          <span className="text-[11px] sm:text-xs text-text-muted font-bold whitespace-nowrap block">
